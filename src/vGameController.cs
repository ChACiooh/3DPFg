...
namespace Invector
{
    ...
    public class vGameController : vMonoBehaviour
    {
        ...
        [vHelpBox("Goal point that if player arrive at this point game is cleared")]
        ...
        protected virtual void Update()
        {
            ...
            if(!isGameover){
                ...
                timeText.text = "Time: " + (int) findTime;
                Debug.Log("current"+currentPlayer.transform.position);
                Debug.Log("goal"+goalPoint.transform.position);
            }
            else
        ...
        public void EndGame(){
            ...
            float bestTime = PlayerPrefs.GetFloat("BesTime");
        ...
        {
            if(currentPlayer.transform.position == goalPoint.transform.position){

...
{
    public class vThirdPersonAnimator : vThirdPersonMotor, vIAnimatorStateInfoController
    {
        #region Variables      
        ...
        {
            if (animatorStateInfos != null) animatorStateInfos.debug = true;
        }
       
        [ContextMenu("Disable AnimatorStateInfos Debug")]
        void DisableAnimatorStateInfosDebug()
        {
            if (animatorStateInfos != null) animatorStateInfos.debug = false;
        }
#endif

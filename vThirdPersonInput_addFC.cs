...
namespace Invector.vCharacterController
{
    ...
    public class vThirdPersonInput : vMonoBehaviour, vIAnimatorMoveReceiver
    {
        ...
        {
            if(!cc.animator.GetCurrentAnimatorStateInfo(0).IsName("Base Layer.Actions.FreeClimb")){
            ...
            /*else if(cc.animator.GetCurrentAnimatorStateInfo(0).IsName(animatorStateHierarchy + ".ClimbWall")){
                switch(num){
                    case 1:
                        cc.input.z = 0;
                        break;
                ...
                switch(num){
                    ...
                    case 2:
                        int rad = UnityEngine.Random.Range(-10, 10);
                        tpCamera.RotateCamera(rad,0);
                        Debug.Log("rotate direction when jump");
                        break;
                    default:
                        break;
                }
